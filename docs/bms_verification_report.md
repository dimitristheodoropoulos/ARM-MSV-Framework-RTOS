...
The I2C measurement-device adapter unit suite (`tests/unit/test_bms_i2c_measurement_device.c`)
verifies:
...
**Scope note:** This verifies the project-defined software I2C measurement-device
adapter and its communication-failure semantics. It does **not** verify physical
I2C hardware, a specific production sensor, ADC, or target-device integration.
...
1. **Requirement 016:** define the required simultaneous multi-fault model and
